...
$query = "SELECT * FROM Appointment_Requests A , pet P WHERE (Date < CURRENT_DATE() OR (Date = CURRENT_DATE() AND Time < CURRENT_TIME)) AND A.status = 'Accepted' and A.PetID = P.ID";
