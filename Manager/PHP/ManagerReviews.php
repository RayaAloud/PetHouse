 ...
 <div class='card-body'>
  ...
  if($data['Rate'] == 0){
    print("<div class='pb-2'>
            <i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;''></i><i class='fa-solid fa-star' style='color: gray;'></i>
          </div>");
  }
  else if($data['Rate'] == 1){
    print("<div class='pb-2'>
            <i class='fa-solid fa-star'></i><i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;'></i>
          </div>");
  }
  else if($data['Rate'] == 2){
    print("<div>
            <i class='fa-solid fa-star'></i><i class='fa-solid fa-star'></i><i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;'></i><i class='fa-solid fa-star' style='color: gray;'></i>
          </div>");
  }
  else if($data['Rate'] == 3){
    print("<div class='pb-2'>
    ...
    print("<div>
    <i class='fa-solid fa-star'></i><i class='fa-solid fa-star'></i><i class='fa-solid fa-star'></i><i class='fa-solid fa-star' style='color: rgb(223, 170, 44);'></i><i class='fa-solid fa-star' style='color: gray;'></i>
     </div>");
  }
  else if($data['Rate'] == 5){
    print("<div>
