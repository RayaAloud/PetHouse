          ...
          <div class="container d-flex justify-content-between align-items-center flex-column-reverse flex-md-row">
            <form method="post" action="#" class="col-6">
                <label for="petname">Pet Name</label> <br>
                  <input type="text" name="petname" id="aPetname" value="Java">

                <label for="birthDate">Date of birth</label> <br>
                  <input type="date" name="birthDate" id="abirthDate" value="4/2/2021">
                ...
                <label for="petbreed">Breed</label>
                  <input type="text" name="petbreed" value="Domestic short-haired">
                <label for="petstatus">Status</label>
                  <input type="text" name="petstatus" value="alive">
            ...
            <div id="addinPic" class="d-flex flex-column">
              ...
              <label for="uploadFile" class="align-self-end"><i class="fa-solid fa-square-pen" id="plusS"></i></label>
           </div>
            </div>
            <div class="d-flex justify-content-center mt-4">
              <div class="col-5 d-flex justify-content-around">
                <a href="MyPets.html"><button class="btns">Cancel</button></a>
                <button class="btns">Save Changes</button>
              </div>
           </div>
        </div>
      </div>
